...
VALUES (DEFAULT, 'Chaise en bois brut avec cousin beige', 'matin', 2, 'en vente', 'accepté', null,
        true, '2023-03-01', '2023-03-15', null, null, '2023-03-18', '2023-03-20', null, null, null, 2, 3, 3);

INSERT INTO pae.objects
VALUES (DEFAULT, 'Canapé 3 places blanc', 'matin', 3, 'vendu', 'accepté', null,
        true, '2023-03-01', '2023-03-15', null, null, '2023-03-18', '2023-03-20', '2323-03-22', null, null, 3, 3, 4);

INSERT INTO pae.objects
VALUES (DEFAULT, 'Secrétaire', 'après-midi', null, 'refusé', 'refusé', 'Ce meuble est magnifique mais fragile pour l’usage qui en sera fait.',
        true, '2023-03-01', null, '2023-03-04', null, null, null, null, null, '0496321654', null, 4, 1);

INSERT INTO pae.objects
VALUES (DEFAULT, '100 assiettes blanches', 'après-midi', null, 'accepté', 'accepté', null,
        true, '2023-03-01', '2023-03-20', null, null, null, null, null, null, null, 4, 4, 9);

INSERT INTO pae.objects
VALUES (DEFAULT, 'Grand canapé 4 places bleu usé', 'après-midi', null, 'accepté', 'accepté', null,
        true, '2023-03-01', '2023-03-20', null, null, null, null, null, null, null, 2, 4, 4);

INSERT INTO pae.objects
VALUES (DEFAULT, 'Fauteuil design très confortable', 'après-midi', null, 'proposé', null, null,
        true, '2023-03-01', null, null, null, null, null, null, null, null, 3, 5, 4);

INSERT INTO pae.objects
VALUES (DEFAULT, 'Tabouret de bar en cuir', 'après-midi', null, 'proposé', null, null,
